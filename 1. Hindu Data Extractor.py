'''
This codes extracts data from newspaper 'The Hindu'
A few metadata have also been collected with Article and Headline
However, only article and headline fields are used in this project
